<template>
    <div class="register-wrap">
        <div class="containera">
            <h1>Welcome</h1>
            <el-form class="registerForm" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px">
                ...
                <el-form-item prop="checkPass">
                    <el-input type="password" v-model="ruleForm.checkPass" placeholder="Confirm Password" @keyup.enter.native="submitForm('ruleForm')">
                    </el-input>
                </el-form-item>
    ...
    methods: {
        ...
        submitForm(formName) {
            ...
            _self.$refs[formName].validate((valid) => {
                if (valid) {
                    common_tools.AJAX('POST', 'http://192.168.120.231:8080/user/regist', _self.ruleForm, function(data) {
                    	console.log(data)
                        if (data.flag == 0) {
                            $('.registerForm').fadeOut(500);
                            $('.register-wrap').addClass('form-success');
                            setTimeout(function() {
...
.register-wrap.form-success .containera h1 {
...
.registerForm .el-form-item.is-error .el-input__inner {
